 ...
 * Abstract: We generate a list of numbers in ascending/descending/random order. We then can use regular quicksort and insertion and/or quicksort median of three to sort the list.
 * We track the amount of time it took for each sorting method and then rank them based on which one is the fastest.
