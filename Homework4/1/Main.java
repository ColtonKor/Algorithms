 ...
 * Abstract: This program takes inputs and solves for the shortest route in the Traveling Salesman Problem.
 * Name: Colton Korhummel
 * Date: 3/1/2024
 */

//I had help from StackOverflow for formatting.
...
public class Main {
    public static void main(String[] args) {
        ...
        if(vertex > 8 || edges > (vertex*(vertex-1))){
